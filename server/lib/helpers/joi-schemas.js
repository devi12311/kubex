...
const joiSupportedCurrencyCode = joiStringNoSpace.uppercase().valid(...getSupportedCurrencyCodes());

const joiSdkSupportedCurrencyCode = joiStringNoSpace.uppercase().valid('EUR', 'ALL', 'GBP', 'USD', 'ILS', 'CAD', 'COP', 'DZD', 'PKR', 'AUD');

const joiNullableEmptySupportedCurrencyCode = joiSupportedCurrencyCode.allow(null, '');

const joiRequiredSupportedCurrencyCode = joiSupportedCurrencyCode.required();
...
const joiPhoneNumberAccountType = Joi.string().valid(...getPhoneNumberAccountTypes());
const joiDefaultPhoneNumberAccountType = joiPhoneNumberAccountType.default('prepaid');

const joiRequiredUkProvider = Joi.string().valid(...getUkProviders()).required();
...
module.exports = {
    ...
    joiRequiredSupportedCurrencyCode,
    joiSupportedCurrencyCode,
    joiSdkSupportedCurrencyCode,
    joiRequiredSdkSupportedCurrencyCode,
    joiNullableEmptySupportedCurrencyCode,
    joiPositiveNumber,
    ...
    joiPhoneNumberAccountType,
    joiDefaultPhoneNumberAccountType,
    joiPositiveInteger,
    joiRequiredPositiveInteger,
    joiRequiredUkProvider
}
